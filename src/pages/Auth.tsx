...
import { Flame, Mail, Lock, User, Phone, ArrowRight, ShoppingBag, Store, Truck } from "lucide-react";
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="login" className="space-y-6">
              ...
              <form className="space-y-4">
                ...
                <Button variant="flame" className="w-full" size="lg">
                  Sign In
              ...
              <form className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="phone" placeholder="0712 345 678" className="pl-10" />
                  </div>
                </div>
